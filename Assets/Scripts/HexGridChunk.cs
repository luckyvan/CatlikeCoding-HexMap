...
public class HexGridChunk : MonoBehaviour
{
    ...
    )
    {
        ...
        TriangulateBoundaryTriangle(
            begin, weights1, left, weights2, boundary, boundaryColor, indices
        );
    ...
    void TriangulateEdgeStrip(
        EdgeVertices e1, Color weights1, float index1,
        EdgeVertices e2, Color weights2, float index2,
        bool hasRoad = false
        )
    {
        Vector3 indices;
